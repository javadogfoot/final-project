...
<%@ include file="/WEB-INF/views/header.jsp"%>
   ...
   <form name="suggestWriteForm" action="suggest.do" method="post">
      <div class="container">
         <!-- 레슨시작일/종료일 -->
         ...
         <div class="introContainer" style="height:634px;">
         ...
         <div class="updateBt">
            ...
            <button class="btn btn-lg btn-primary" type="submit"
               style="width: 450px; margin-bottom: 20px; background-color:#ff9797; border-color: #ff9797;">제안하기</button>
