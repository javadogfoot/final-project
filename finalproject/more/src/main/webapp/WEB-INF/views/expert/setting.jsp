            ...
            <c:if test="${sessionScope.sessionStatus == 2 }">
              <div class="my-3">
	            ...
	            <div class="align-content-center">
	              <div class="change-user-status text-secondary cursor-pointer mt-0" style="text-align: center;">전문가로 이용하기<i></i></div>
	          </div>
       		</c:if>
        </div>
        <div class="card shadow-sm p-5 mb-2">
          <div>
            ...
            <ul class="m-0">
              ...
              <c:if test="${sessionScope.sessionStatus == 2 }">
              <li class="mb-3">
                <a href="" name="" class="text-secondary d-flex align-items-center">
                  <i></i>
                  <p class="m-0 col-11 p-0 font-subhead">모레 설정</p>
                </a>
              </li>
              <li class="mb-3">
