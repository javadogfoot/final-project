  ...
  <div class="revMainContainer">
		<div class="revMainTextBox">
			<div class="revMainText">
				<h1>
					내가 받은 제안서<br>
					<span style="font-size:25px; font-weight:normal; border-top: 1px solid white; padding: 5px;">받은 제안서 목록을 확인해보세요</span>
				</h1>		
			</div>
		</div>
	</div>
                  ...
                  <div class="col-4 pr-0 text-right">
                    <div>
                        ...
                        <div class="font-weight-semi-bold" style="text-align: right;">   
                            <button type="button" class="btn btn-primary lg">${dto.id }전문가님</button>
                        </div>
                    </div>
                  </div>
                </div>
