...
<div class="revMainContainer">
      <div class="revMainTextBox">
         <div class="revMainText">
            <h1>
               레슨 목록<br>
               <span style="font-size:25px; font-weight:normal; border-top: 1px solid white; padding: 5px;">마음에 드는 레슨을 선택해보세요</span>
            </h1>   
         </div>
      </div>
   </div>
  ...
  <br>
    <div class="container list-main-container">
      ...
      <form name="category" action="suggestList.do">
  ...
  <div class="summary-box bg-white" style="width: 900px;margin-left: 220px">
    <a href="sugContent.do?s_idx=${dto.s_idx }">
      ...
      <div class="row">
        ...
        <div class="col-xs-8 is_offered_list">
          ...
          <p class="first-info">
             ...
             <button type="button" class="btn btn-outline-info">${fn:substring(dto.start_date,0,10)} ~ ${fn:substring(dto.end_date,0,10) }</button>
            <br class="only-mobile-visible">
          </p>
          <p class="summary-information" style="background-color: #eeeeee; padding: 20px; height: 100px; white-space: pre;">${dto.s_intro }</p>
        </div>
        <div class="col-xs-2 text-center sub-info-col only-desktop-visible" style="margin-top: 50px;">
          <p>
               <span class="client-partner-distance">
             <button type="button" class="btn btn-outline-primary">${dto.day }</button>
              </span> 
              <br>
              <span class="submitted-time"></span>
              <br>
              <span>
                 <button type="button" class="btn btn-outline-danger">${dto.cost }만원</button>
              </span>
          </p>
        </div>
       </div>
