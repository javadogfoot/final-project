 ...
 * Generated at: 2021-12-14 04:51:08 UTC
...
public final class join_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("     background-color:#b6847f;\r\n");
      ...
      out.write("      <form class=\"needs-validation\" method=\"POST\" action=\"joinAction.do\" onsubmit=\"return checks()\">\r\n");
      out.write("     <div class=\"py-4 text-center\">\r\n");
      out.write("         <img class=\"d-block mx-auto mb-4\" id=\"profile\" src=\"resources/img/profile_default.png\" alt=\"\" width=\"120\" height=\"80\" style=\"border: 1px solid gray; border-radius: 7px;-moz-border-radius: 7px;-khtml-border-radius: 7px;-webkit-border-radius: 7px;\">\r\n");
      out.write("         <label id=\"file_btn\" for=\"input-file\">\r\n");
      out.write("           사진 등록\r\n");
      out.write("         </label>\r\n");
      ...
      out.write("        </div>\r\n");
      out.write("        <div class=\"mb-2\">\r\n");
      out.write("            <label>이메일</label><input type=\"button\" class=\"btn btn-primary\" id=\"emailsend\" value=\"인증번호 전송\" style=\"position: absolute; margin-left: 300px; margin-top: 26px; line-height: 1.3;\">\r\n");
      out.write("            <input type=\"email\" class=\"form-control\" id=\"email\" name=\"email\" style=\"width: 70%\">\r\n");
      out.write("            <div id=\"email_check\"></div>\r\n");
      out.write("            <label>인증번호</label><input type=\"button\" class=\"btn btn-primary\" id=\"emailcheck\" value=\"인증번호 확인\" disabled=\"disabled\" style=\"position: absolute; margin-left: 283px; margin-top: 26px; line-height: 1.3;\">\r\n");
      out.write("            <input type=\"text\" class=\"form-control\" id=\"email2\" name=\"email2\" style=\"width: 70%\">\r\n");
      out.write("            <div id=\"email_check2\"></div>\r\n");
      out.write("        </div>\r\n");
      out.write("        <div class=\"mb-2\">\r\n");
      out.write("            <label>전화번호</label> \r\n");
      out.write("            <input type=\"text\" class=\"form-control\" id=\"tel\" name=\"tel\">\r\n");
      out.write("            <div id=\"tel_check\"></div>\r\n");
      out.write("        </div>\r\n");
      out.write("        <div class=\"mb-2\">\r\n");
      out.write("          <input type=\"text\" class=\"col-sm-3 form-label\" name=\"zip_code\" id=\"postcode\" placeholder=\"우편번호\" style=\"border-radius: 0.25rem; border: 1px solid #ced4da;\">\r\n");
      out.write("            <input type=\"button\" class=\"btn btn-primary\" id=\"zip_code_btn\" onclick=\"execDaumPostcode()\" value=\"우편번호 찾기\" disabled=\"disabled\" style=\"line-height: 0.9; margin-bottom: 4px;\">\r\n");
      out.write("            <input type=\"text\" class=\"form-control\" name=\"addr\" id=\"address\" placeholder=\"주소\" style=\"margin-bottom: 5px\">\r\n");
      out.write("            <input type=\"text\" class=\"form-control\" name=\"d_addr\" id=\"detailAddress\" placeholder=\"상세주소\">\r\n");
      ...
      out.write("           <button class=\"btn btn-primary btn-lg btn-block\" id=\"submit\" type=\"submit\" disabled=\"disabled\">가입하기</button>\r\n");
      out.write("        </div>\r\n");
      out.write("      </form>\r\n");
      out.write("    <script>\r\n");
      out.write("   let code =  \"\";\r\n");
      out.write("   $('#emailsend').click(function() {\r\n");
      out.write("      let email = $('#email').val();\r\n");
      out.write("      $.ajax ({\r\n");
      out.write("         type : 'GET',\r\n");
      out.write("         url : \"mailCheck.do?email=\" + email,\r\n");
      out.write("         cache : false,\r\n");
      out.write("         success : function(data) {\r\n");
      out.write("            if (data == \"error\") {\r\n");
      out.write("               $('#email_check').text(\"유요한 이메일 주소를 입력해주세요. ex) more@gmail.com\");\r\n");
      out.write("               $('#email_check').css(\"color\", \"red\");\r\n");
      out.write("            } else {\r\n");
      out.write("               $('#email_check').text(\"\");\r\n");
      out.write("               $('#email_check2').text(\"인증번호 입력 해주세요\");\r\n");
      out.write("               $('#email_check2').css(\"color\", \"red\");\r\n");
      ...
      out.write("      let email2 = $('#email2').val();\r\n");
      out.write("      $.ajax ({\r\n");
      out.write("         success : function() {\r\n");
      out.write("            if (email2 == code) {\r\n");
      out.write("               $('#email_check2').text(\"인증번호가 일치합니다!\");\r\n");
      out.write("               $('#email_check2').css(\"color\", \"green\");\r\n");
      out.write("               $('#tel').focus();\r\n");
      out.write("            } else {\r\n");
      out.write("               $('#email_check2').text(\"인증번호가 일치하지 않습니다!\");\r\n");
      out.write("               $('#email_check2').css(\"color\", \"red\");\r\n");
      out.write("            }\r\n");
      out.write("         }\r\n");
      out.write("      })\r\n");
      ...
      out.write("</script>\r\n");
      out.write("    <script>\r\n");
      out.write("      let getCheck= RegExp(/^[a-zA-Z0-9]{4,12}$/); // 소문자와 숫자 4~12\r\n");
      out.write("      let telCheck =  RegExp(/^[0-9]{2,3}-[0-9]{4}-[0-9]{4}/);\r\n");
      out.write("      // 아이디 유효성 검사\r\n");
      out.write("      $(\"#id\").blur(function () {\r\n");
      out.write("         let id = $('#id').val();\r\n");
      out.write("         $.ajax ({\r\n");
      out.write("            url : 'idCheck.do?id=' + id,\r\n");
      out.write("            type : 'post',\r\n");
      out.write("            success : function (data) {\r\n");
      out.write("               if (data == 1) {\r\n");
      ...
      out.write("                  $('#zip_code_btn').attr(\"disabled\", true);\r\n");
      out.write("               }   else if (id == \"\") {\r\n");
      out.write("                  $('#id_check').text(\"아이디를 입력해주세요!\");\r\n");
      out.write("                  $('#id_check').css(\"color\", \"red\");\r\n");
      out.write("                  $('#submit').attr(\"disabled\", true);\r\n");
      out.write("                  $('#zip_code_btn').attr(\"disabled\", true);\r\n");
      out.write("               }   else if (!getCheck.test($('#id').val())) {\r\n");
      out.write("                  $('#id').val(\"\");\r\n");
      ...
      out.write("                  $('#id_check').text(\"사용가능한 아이디입니다!\");\r\n");
      out.write("                  $('#id_check').css(\"color\", \"green\");\r\n");
      out.write("                  $('#zip_code_btn').attr(\"disabled\", false);\r\n");
      out.write("               }\r\n");
      ...
      out.write("            success : function () {\r\n");
      out.write("               if (pwd == \"\") {\r\n");
      out.write("                  $('#pwd_check').text(\"비밀번호를 입력해주세요!\");\r\n");
      out.write("                  $('#pwd_check').css(\"color\", \"red\");\r\n");
      out.write("                  $('#submit').attr(\"disabled\", true);\r\n");
      out.write("                  $('#zip_code_btn').attr(\"disabled\", true);\r\n");
      out.write("               } else if (id == pwd) {\r\n");
      out.write("                  $('#pwd').val(\"\");\r\n");
      out.write("                  $('#pwd_check').text(\"아이디와 비밀번호가 같습니다!\");\r\n");
      out.write("                  $('#pwd_check').css(\"color\", \"red\");\r\n");
      out.write("                  $('#submit').attr(\"disabled\", true);\r\n");
      out.write("                  $('#zip_code_btn').attr(\"disabled\", true);\r\n");
      out.write("               }   else {\r\n");
      ...
      out.write("            success : function () {\r\n");
      out.write("               if (tel == \"\") {\r\n");
      out.write("                  $('#tel_check').text(\"전화번호를 입력해주세요!\");\r\n");
      out.write("                  $('#tel_check').css(\"color\", \"red\");\r\n");
      out.write("                  $('#submit').attr(\"disabled\", true);\r\n");
      out.write("                  $('#zip_code_btn').attr(\"disabled\", true);\r\n");
      out.write("               } else if (!telCheck.test($('#tel').val())) {\r\n");
      out.write("                  $('#tel_check').text(\"전화번호를 형식에 맞춰주세요! ex) 010-1234-5678\");\r\n");
      out.write("                  $('#tel_check').css(\"color\", \"red\");\r\n");
      out.write("                  $('#submit').attr(\"disabled\", true);\r\n");
      out.write("                  $('#zip_code_btn').attr(\"disabled\", true);\r\n");
      out.write("               } else {\r\n");
      out.write("                  $('#tel_check').text(\"\");\r\n");
