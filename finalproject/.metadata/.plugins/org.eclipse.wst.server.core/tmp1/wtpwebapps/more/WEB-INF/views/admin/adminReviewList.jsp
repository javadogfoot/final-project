...
<%@ include file="/WEB-INF/views/adminSidebar.jsp"%>
   ...
   <section>
      <h5>
         <b><a href="adminReviewList.do">후기게시판 관리</a></b>
      </h5>
      <br>
      <form name="reviewSearch" action="adminReviewList.do">
      ...
      <div>
         ...
         <c:if test="${!empty list}">
            <c:forEach var="dto" items="${list}" varStatus="status">
               <c:url var="contentUrl" value="adminReviewContent.do">
                  <c:param name="rv_idx">${dto.rv_idx}</c:param>
               </c:url>
               ...
               <div style="padding-bottom: 20px; font-size: 17px;">
				  ...
				  <input type="button" class="btn btn-outline-danger btn-sm"
						onclick="removeCheck(${dto.rv_idx})" value="삭제" style="margin-bottom: 20px;"></c:if>
               </div>
      ...
      class="font-footnote text-secondary">작성자: ${dto.id}/${dto.name}</span></li>
   <li class="list-inline-item mx-0">
      <div class="font-footnote text-secondary">·</div>
   </li>
   <li class="list-inline-item mx-0"><span
      class="font-footnote text-secondary">전문가: ${dto.e_id}</span></li>
      <li class="list-inline-item mx-0">
      <div class="font-footnote text-secondary">·</div>
   <li class="list-inline-item mx-0"><span
      class="font-footnote text-secondary">카테고리: ${dto.cate1} / ${dto.cate2}</span></li>
   <li class="list-inline-item mx-0">
      <div class="font-footnote text-secondary">·</div>
   </li>
   <li class="list-inline-item mx-0"><span
      class="font-footnote text-secondary">작성일: ${dto.regdate}</span></li>
                           </ul>
                        </div>
                     </div>
                  </a>
